...
compare-shared-blocks-third-party-tracking = Bloquea las cookies de seguimiento de terceros
compare-shared-blocks-cryptomining-scripts = Bloquea los scripts de criptominería
...
compare-shared-tab-browsing = Navegación por pestañas
compare-shared-bookmark-manager = Administrador de marcadores
compare-shared-automatically-fills-out-forms = Completa formularios automáticamente
...
compare-shared-web-extensionsadd-ons = Extensiones / complementos web
compare-shared-in-browser-screenshot-tool = Herramienta de captura de pantalla en el navegador
compare-shared-os-availability = Disponibilidad del sistema operativo
compare-shared-mobile-os-availability = Disponibilidad de SO móvil
compare-shared-syncs-with-mobile = Se sincroniza con el móvil
compare-shared-password-management = Gestión de contraseñas
...
compare-shared-the-comparisons-made-here = Las comparaciones realizadas aquí se realizaron en las versiones de lanzamiento del navegador de la siguiente manera:
compare-shared-this-page-updated-semi-quarterly = Esta página se actualiza cada dos meses para reflejar las últimas versiones y es posible que no siempre refleje las últimas actualizaciones.
