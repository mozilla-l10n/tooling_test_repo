...
fxa-form-enter-your-email = <strong>Voer uw e-mailadres in</strong> om toegang te krijgen tot { -brand-name-firefox-accounts } .
...
fxa-form-continue = Doorgaan met
fxa-form-create-account = Maak een account aan
