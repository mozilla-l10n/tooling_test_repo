...
features-shared-more-firefox-features = Más { -brand-name-firefox } funciones del navegador
...
features-shared-ad-tracker-blocking = Bloqueo del rastreador de anuncios
...
features-shared-sync-between-devices = Sincronizar entre dispositivos
